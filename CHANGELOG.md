...
- Root package-manager authority now resolves `qs` to `6.16.0`, removing the shared `qs@6.15.3` graph reported for CVE-2026-82417 and CVE-2026-82562 without scanner suppression or a leaf-package override.
