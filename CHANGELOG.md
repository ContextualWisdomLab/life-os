...
- CI PostgreSQL service initialization now uses an immutable locale-capable PostgreSQL 16 Debian image with explicit SCRAM authentication for local and host connections, preventing implicit trust-authentication and missing-locale startup warnings.
