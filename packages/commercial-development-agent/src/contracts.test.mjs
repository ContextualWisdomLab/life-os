...
describe('commercial development policy contract', () => {
  ...
  it.each([
    ...
    { ...policy(), allowed_path_prefixes: null },
    { ...policy(), allowed_path_prefixes: ['apps'] },
    { ...policy(), allowed_path_prefixes: ['../apps/'] },
    { ...policy(), allowed_path_prefixes: ['/apps/'] },
    { ...policy(), allowed_path_prefixes: ['apps\\/'] },
    { ...policy(), allowed_path_prefixes: ['apps/', 'apps/'] },
    { ...policy(), prohibited_path_prefixes: null },
    { ...policy(), prohibited_path_prefixes: [] },
    { ...policy(), prohibited_path_prefixes: ['.git/', '.git/'] },
    { ...policy(), allowed_root_files: null },
    { ...policy(), allowed_root_files: [] },
    { ...policy(), allowed_root_files: ['README.md', 'README.md'] },
    { ...policy(), allowed_root_files: ['nested/file.md'] },
    { ...policy(), allowed_root_files: ['nested\\file.md'] },
    { ...policy(), allowed_root_files: ['.'] },
    { ...policy(), allowed_root_files: ['..'] },
    { ...policy(), prohibited_exact_paths: null },
    { ...policy(), prohibited_exact_paths: [] },
    { ...policy(), prohibited_exact_paths: ['.env', '.env'] },
    ...
    { ...policy(), maximum_changed_bytes: 10_485_761 },
...
describe('external issue projection contract', () => {
  ...
  it.each([
    ...
    {
      ...issue(),
      url: 'https://github.com/ContextualWisdomLab/life-os/issues/120',
    },
    { ...issue(), title: '' },
...
describe('credential-free receipt contract', () => {
  ...
  it.each([
    ...
    { ...receipt(), issue: null },
    { ...receipt(), branch_name: null },
    { ...receipt(), pull_request_url: null },
