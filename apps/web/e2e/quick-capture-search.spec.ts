...
/** Clears browser-local Today state before each independent user flow. */
...
test('keeps browser-local capture distinct from durable workspace search', async ({
  page,
}) => {
...
test('announces empty, unauthenticated, and unavailable search states', async ({
  page,
}) => {
