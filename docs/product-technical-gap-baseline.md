...
- #245 `f74d417e61f6ede62e2ca74eb275906074f28347`: Draft concrete node-postgres/default-entrypoint successor, stacked directly on #244 with `behind_by=0` and seven Integration-owned source/test/architecture/changelog/manifest paths. It keeps the service manifest, concrete Pool adapter/test, executable entrypoint/test, and code-current architecture/changelog in the Integration bounded context rather than borrowing another service's persistence.
