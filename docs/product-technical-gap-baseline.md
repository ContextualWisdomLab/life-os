...
#243 still receives already-constructed Integration-owned installation/binding/replay ports from its caller, this connector runtime cannot execute the workspace package graph, and the non-default stacked PR cannot inherit parent workflow evidence; therefore no package/repository GREEN is claimed. The next Plugin dependency is one service-owned PostgreSQL runtime that constructs those ports, registers the composed operator in `IntegrationAppModule` before listener start, fails closed when required PostgreSQL/Vault/operator configuration is unavailable, and closes its owned pool exactly once on shutdown. Real Vault integration acceptance must then prove the composed path. Only after those gates should #130 advance to separately reviewed SSRF/DNS-rebinding-safe outbound HTTPS with connect-time address enforcement or equivalent reviewed egress, redirect/proxy denial, finite byte/deadline limits, signed/idempotent delivery, durable attempt/outcome/retry/dead-letter evidence, revocation fencing, operator recovery, and buyer-visible status. Do not source-copy Calendar secret storage into Plugin or treat another bounded context's persistence as Plugin authority. #205, #235, #241, #242, and #243 remain active evidence, not shipped truth.
...
Standards and research references belong in `docs/doctoring/REFERENCES.md` and canonical TRACEABILITY with APA 7th formatting. Maintain current traceability for ISO/IEC 25010:2023, ISO/IEC 40500:2025 / WCAG 2.2, NIST SP 800-63-4, OWASP ASVS 5.0.0, SPDX 3.0.1, SLSA 1.2, and cited goal-setting, implementation-intention, and habit-formation research. PostgreSQL concurrency decisions must cite current supported PostgreSQL documentation. #242 transport cleanup traces to WHATWG Streams cancellation and Node.js Undici response-body resource guidance; primary/official references justify mechanisms but are not execution evidence. Do not turn mappings into certification claims.
...
Refs #21, #55, #129, #130, #145, #198, #199, #202, #205, #209, #210, #211, #212, #214, #216, #217, #218, #228, #230, #235, #236, #237, #238, #240, #241, #242, #243.