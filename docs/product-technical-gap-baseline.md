...
- #245 `9551b20fb7d9ac2795110301e9340c67c6d1ed37`: Draft concrete node-postgres/default-entrypoint successor, stacked directly on #244 with `behind_by=0` and seven Integration-owned source/test/architecture/changelog/manifest paths. It keeps the service manifest, concrete Pool adapter/test, executable entrypoint/test, and code-current architecture/changelog in the Integration bounded context rather than borrowing another service's persistence.
