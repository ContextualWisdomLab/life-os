...
| CodeQL current-head terminal authority | central dispatch/receipt contract | #249 CodeQL `34448871609`: language detection and dispatch job `102784476918` SUCCESS; three compatibility jobs fail terminal-verdict enforcement. Current settlement owner `.github#2106@9defd52f4a3b42d6a63a9520d6da82224d8c864d` has coordinator `104162751101` SUCCESS and producer run `34919439638` queued with no terminal conclusion | Fail closed; no CodeQL acceptance until authenticated terminal settlement |
